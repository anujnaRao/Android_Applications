...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.activity_list_view_item, null, true);
        ...
        holder.tvmodel.setText("Hobby: "+userModelArrayList.get(position).getModel());
    ...
    private class ViewHolder {
        ...
        protected TextView tvname,tvmodel;
    }
}
